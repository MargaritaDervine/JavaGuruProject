...
public abstract class JDBCRepository {
    ...
    protected Connection getConnection() {
        try{
            ...
            System.out.println("Exception while getting connection to java2courseIbank.database");
            e.printStackTrace();
            throw new RuntimeException(e);
        }
    }
    ...
    protected void closeConnection(Connection connection) {
        try {
            ...
            System.out.println("Exception while closing connection to java2courseIbank.database");
            e.printStackTrace();
            throw new RuntimeException(e);
        }
    }
